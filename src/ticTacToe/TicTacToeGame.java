        ...
        public void actionPerformed(ActionEvent e) {
            ...
            else
            {
                if (next.equals(player1)) {
                    ...
                    if ( isWinner( 'X' ) == true )
                    {
                         ...
                         log.info(player1+" has won");
                         db.updateWin(player1);
                         log.info(player2+" has lost");
                         db.updateLoss(player2);
                         return;
                        ...
                        {
                            setButtonsEnabled(player2); 
                            log.info(player2+" has won");
                            db.updateWin(player2);
                            log.info(player1+" has lost");
                            db.updateLoss(player1);
            ...
            if ( isTie() == true )
            {
                setButtonsEnabled("Tie");
                 ...
                 db.updateTie(player1,player2);
                 
                 log.info(player1+" and " +player2+ " has tied");
